	...
	return (
		<div className='relative w-full overflow-hidden bg-urbain-white lg:h-screen'>
			<div className='mx-auto flex h-full w-full flex-col items-center space-y-16 py-16 lg:w-4/5 lg:pt-32'>
				<h2 className='w-full text-center font-play-fair text-3xl leading-snug tracking-wider text-urbain-black sm:text-4xl md:text-5xl lg:max-w-2xl lg:text-6xl'>
					Produits populaires
				</h2>
